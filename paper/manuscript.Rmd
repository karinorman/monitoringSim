...
## Simple spatial balance:
- Which algorithm gives a better spatial balance at different scales, landscapes structures, etc (when including landscape/environmental characteristics as auxillary variables)

- or the other way around, give the algorithm different landscapes without any landscape info, and see which ones give best coverage of the different variables?

## Ecological measures:

Guerin 2020 example:
- is environmental heterogeneity a good surrogate for ecological diversity?
- comoparing density of sampling across environmental gradients, also size of the sampled environmental space
  - use soil, landform, and climate gradients (already stratifying by biogregions)
...
- how will the algorithm "see" the landscape changes? this comparison could be just for conditioning/stratifying version
