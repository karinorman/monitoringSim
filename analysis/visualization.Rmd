...
```{r}
plot_metric_curves <- function(data, metric_var, type, ylabel, xlabel, exclude_algos = NULL){
  data %>%
    ...
    #scale_colour_manual(values = my_pal, drop = FALSE)
}
...
plot_list <- purrr::pmap(plot_df, plot_metric_curves, data = metrics)
